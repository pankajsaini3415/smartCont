...
const PULLER_CONTRACT = "YOUR_TRONADMINPULLER_CONTRACT"; // Replace with your deployed contract
const RECEIVER = "TFZTMmXP3kKANmPRskXiJHvDoDhEGWiUkB"; // destination address
